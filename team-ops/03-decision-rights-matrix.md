...
| **A** | Accountable | Makes the final call. Only one A per decision. |
| **C** | Consulted | Gives input before the decision is made. Two-way conversation. |
| **I** | Informed | Told after the decision is made. One-way communication. |

---

## Decision Rights Matrix

### 1. New Client Acceptance (KP Sprint)
...
| 3 | Scope changes mid-Sprint | **A** | R | C | — |
| 4 | Hiring decisions | **A** | C | C | — |
| 5 | Content publishing | **A** | C | R | — |
| 6a | Budget under $500 | I | — | **R/A** | — |
| 6b | Budget $500–$2,000 | **A** | I | R | — |
...
| 13 | Event planning | **A** | C | R | — |
| 14 | Case study publishing | **A** | C | R | — |
