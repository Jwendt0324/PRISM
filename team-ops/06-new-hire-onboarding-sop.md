...
**Goal:** New hire has every tool they need, knows who everyone is, and has their reading list.
...
- [ ] First small task assigned and started:
  ...
  - Sales/BD: Research 5 prospects using the KP Sprint framework
- [ ] Submit first EOD report in Basecamp (even if it's just "read docs all day" — the habit starts Day 1)
...
- [ ] Feedback session with [Your Name] (15-30 min, 1:1):
  ...
  - Adjust workload up or down based on performance
- [ ] Begin contributing to team discussions in Basecamp — not just receiving tasks, but flagging issues, suggesting improvements, asking questions in threads
- [ ] Daily EOD reports, weekly MAA — no exceptions

---

## Weeks 3-4

**Goal:** Full workload ramp-up. Operating at expected capacity.
...
- How many deliverables completed? ___
- How many passed QA on first submission? ___
- Average revision cycles per deliverable? ___
- EOD/MAA report compliance (% submitted on time)? ___

**2. Tool Proficiency**
- Comfortable with all tools? (Y/N) ___
- Any access issues unresolved? ___

**3. Cultural Fit**
- Contributing in Basecamp threads? (Y/N) ___
- Attending all meetings? (Y/N) ___
- Communicating proactively when blocked? (Y/N) ___
...
**6. Decision**
- [ ] Continue — on track
- [ ] Continue with improvement plan (document specifics)
- [ ] Not a fit — end engagement

---

## 60-Day Evaluation Criteria

At 60 days, the new hire should meet ALL of the following. If they don't, it's a serious conversation.
...
Every tool, who grants access, and which roles need it.
...
## Required Reading by Role Type

Assign on Day 1. Due by end of Day 3. New hire confirms completion in Basecamp.

### Content Specialist
1. Team OS Overview (00-team-os-overview.md)
2. Communication Protocol (02-communication-protocol.md)
3. Article Writing from Transcripts SOP
4. Article QA & Compliance SOP
5. Content Factory Execution SOP
6. Knowledge Panel Sprint SOP (understand the product you're producing content for)
...
These are real patterns. Not theoretical.
