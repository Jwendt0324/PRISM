...
| Trigger | SOP | Path |
|---------|-----|------|
| HRI offer, pricing, GTM, go-to-market, service packages, offer ladder | HRI Offer Ladder & GTM Blueprint | sops/business-ops/hri-offer-ladder-and-gtm.md |
| Event planning, The Forge, in-person event, speaker event, conference | Event Planning (The Forge) | sops/business-ops/event-planning.md |
...
| Refund, client refund, payment dispute, chargeback, escalation to Dennis | Refund & Escalation | sops/business-ops/refund-escalation.md |
...
| Jackson onboarding, Jackson's tasks, Jackson success metrics | Jackson Jerdee Onboarding Kit | team-ops/07-jackson-onboarding-kit.md |
...
| Pain points, friction, systemic issues, what's broken at HRI | Current Pain Points | team-ops/14-current-pain-points.md |
