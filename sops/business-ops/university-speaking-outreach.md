---
description: Outreach and execution process for university guest lectures and speaking engagements
...
4. **Propose a specific session.** Don't be vague. Offer one of:
   ...
   - Hands-on workshop (students work on real campaigns)
   - Multi-session series (3-5 sessions across a semester)
   - Include proposed topics, learning outcomes, and what students walk away with.

5. **Confirm logistics.** Lock down: date, time, format (in-person or virtual), duration, expected audience size, AV requirements, and whether recording is permitted. Get this in writing.

6. **Create a Basecamp thread for the engagement.** Include: professor name, university, department, session details, prep timeline, deliverables promised. Every engagement gets its own thread.

7. **Prepare materials.** Build or customize: slides, handouts, follow-up resource links, any pre-session assignments for students. Have materials ready **3 days before** the session — not the night before.

8. **Deliver the session and record it.** Always ask permission to record. Use the recording for content repurposing. If recording isn't permitted, take detailed notes for an article write-up.

9. **Follow up within 48 hours.** Send the professor:
   - A thank-you email
   - A request for a testimonial or written feedback
   - An offer for a follow-up session or recurring series
   - Any promised follow-up resources or materials
...
- **Canon source:** 06-topic-wheel.md
