...
- See separate SOP: knowledge-panel-sprint.md for delivery process
...
### Governance Cadence
- Weekly 30-min Pipeline & Delivery Standup (Tuesdays)
- Public scoreboard: closes, on-time %, defect rate, client CSAT, case studies shipped

## Curriculum (Core Modules)

Content Factory core (rebranded/refreshed):
One-Minute Video, Dollar-a-Day, Spotlight Articles, Weekly MAA, Topic Wheel, Interviewing, GBP basics, Filming on iPhone, Knowledge Panel foundations, Marketing Mechanic

AI-first updates: Descript workflows, transcript-to-shorts/articles, DARIN-assisted cross-mentions, SPP automation, AI disclosure
...
### Knowledge Panel Sprint (Product A)
- Throughput: 12 Sprints in 90 days
- On-time delivery: >=90%
- Case studies: >=3 named
- NPS/CSAT: >=9/10

### AI Apprentice (Product B)
- Cadence: 1 new module/month shipped; weekly live on schedule
- Outcomes: 5 apprentice placements/quarter into Sprints or client teams
- Community NPS: >=9/10
- Conversion: >=25% enrolled complete capstone and pass QA
