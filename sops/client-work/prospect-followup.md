...
1. **Log the prospect immediately.** Record in Basecamp or the prospect tracking system:
   - Name
   - Email
   - Service interest (KP Sprint, AI Apprenticeship, Content Factory, other)
...
3. **Qualify the prospect against the relevant criteria.**
   ...
   **For all other services:**
   - Budget alignment, timeline, and scope clarity before scheduling a call.

4. **Handle price objections for KP Sprint prospects.** If the prospect is interested but balks at pricing:
   a. Offer the **free DIY path**: direct them to Marketing Mechanic episode 5, which walks through the process they can do themselves.
   b. Offer the **Quick Audit ($297)**: a low-commitment entry point that demonstrates value. Positions the full sprint as the logical next step.
   - Do not discount the full sprint price. Give alternatives, not discounts.
...
6. **If no response after initial contact, follow up at these intervals:**
   - **48 hours:** Brief follow-up. Reference the original conversation. Ask if they have questions.
...
|------|-----------|--------|
| Initial response within 24 hours (Step 2) | Execute | Human-written acknowledgment — speed builds trust |
