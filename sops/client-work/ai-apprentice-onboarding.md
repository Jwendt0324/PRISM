...
1. **Assign the qualification task.** The prospect must repurpose the latest Marketing Mechanic video into:
   ...
   - **All three deliverables are required.** Do not bypass this step. The Jackson lesson: Dennis will push back hard if someone is admitted without meeting all qualification criteria.
...
5. **Muzamil sends Academy credentials.** The apprentice gets login access to `academy.yourcontentfactory.com`. Confirm credentials are sent within 24 hours of payment.

6. **Keap sends the welcome email sequence:**
   a. Welcome video from Dennis
...
9. **Monitor MAA submissions weekly.** Track whether each apprentice is submitting their Friday MAA:
   ...
   - **2 weeks missed:** Escalate to Jack or Dennis. Direct outreach to the apprentice.
...
- [ ] Academy access confirmed at `academy.yourcontentfactory.com`
...
## Common Pitfalls
- **Admitting apprentices who did not complete all qualification criteria.** The Jackson lesson: Dennis pushed back when qualification standards were bypassed. The qualification task is the filter — it proves the apprentice can execute. Do not shortcut it.
...
| Dennis approval before admission | Approve | The Jackson lesson — Dennis must sign off on every new apprentice |
...
- **Human checkpoints:** Qualification review — human must assess article for AI language patterns; Dennis approval required before admission (the Jackson lesson); weekly MAA review by ops team; escalation ladder at 1 week, 2 weeks, 3+ months inactive
...
## Learnings Log
- *2026-03-18* — SOP created based on AI Apprentice Program operations, Jackson qualification incident, and Morgan Gopaul engagement recovery case.
