# Overnight Task: FULL PRISM OVERHAUL — Infrastructure Fix + Revenue Execution

## Instructions for Claude Code

Copy everything below the line into Claude Code and let it run overnight. This is the biggest single run the PRISM has ever done. It fixes every known problem AND produces revenue-generating output.
...
Read these files FIRST to understand everything that needs fixing:
- ~/Documents/Claude/PRISM/blitzmetrics-canon/honest-assessment.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/sop-audit-report.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/10-anti-vandalism-checklist.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/01-nine-triangles.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/02-content-factory-process.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/03-article-guidelines.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/08-human-requirements.md
- ~/Documents/Claude/PRISM/INDEX.md
- ~/Documents/Claude/PRISM/CONTEXT.md

---

# PHASE 1: REWRITE ALL CRITICAL SOPs (2-3 hours)

The SOP audit found that NONE of the 25+ SOPs reference the 9 Triangles, LDT, or CCS frameworks. Three SOPs were flagged as NEEDS REWRITE. The rest need Canon Compliance sections added.

## Step 1A: Rewrite the 3 Critical SOPs

These were flagged as NEEDS REWRITE in the audit report. Read each one, read the canonical source, and rewrite from scratch:

**1. sops/client-work/content-factory-execution.md**
- Must use the canonical 6-stage Content Factory (not 4 or 5)
- Must reference 9 Triangles at each stage (which triangle governs each stage?)
- Must include MAA loop at every stage (how do we measure success at each stage?)
- Must define human checkpoints (what requires a human at each stage?)
- Must include anti-vandalism rules (what could go wrong at each stage?)
- Must follow CCS format: Content (what), Checklist (how), Software (tools)
- Must include LDT context: how does someone learn this, do this, then teach this?

**2. sops/client-work/article-writing-from-transcripts.md**
- Must align with blitzmetrics-canon/03-article-guidelines.md (the 18-step checklist)
- Must reference the Content Engine v5 quality standards (banned words, banned patterns, burstiness, structure randomization)
- Must include the [Methodology Partner] QA gate as a mandatory final step
- Must define what "done" means (not just "article written" but "article passes 18-step QA, meta-article generated, content tree verified")
- Must include anti-vandalism: check for keyword cannibalization before writing

**3. sops/client-work/article-qa-blitzmetrics.md**
- This is the OLD QA SOP that only caught mechanical issues
- Replace it entirely with a redirect to the new article-qa-blitzmetrics.md
- Or merge the best parts of both into a single comprehensive QA SOP
- The result must include ALL 18 [Methodology Partner] steps plus the Content Engine v5 quality rules

## Step 1B: Add Canon Compliance to ALL Remaining SOPs

For every SOP in ~/Documents/Claude/PRISM/sops/ that was NOT fully rewritten:

1. Read the SOP
2. Read the relevant canon files
3. Add a "Canon Compliance" section at the end with:
   - Which 9 Triangles govern this SOP (e.g., "GCT: every article starts with goals")
   - Which [Methodology Partner] canonical doc this SOP implements
   - Where humans are required
   - Anti-vandalism notes specific to this SOP
4. Fix any factual contradictions found in the audit
5. Add MAA loop if missing (how do we measure whether this SOP is producing results?)
6. Bump the version number

Do NOT rewrite SOPs that passed the audit — only add the compliance section and fix specific issues.

## Step 1C: Update Team-Ops SOPs

The team-ops/ SOPs also need canon compliance. For each file in ~/Documents/Claude/PRISM/team-ops/:
- Add 9 Triangles references where applicable
- Add MAA measurement (how do we know the team process is working?)
- Verify human requirements are clearly defined
- Bump version numbers

---

# PHASE 2: REGENERATE CONTEXT.md (30 min)

The current CONTEXT.md doesn't include the [Methodology Partner] canon. Regenerate it from scratch.

Read ALL of these and compress into a single file under 5,000 words:
- ~/Documents/Claude/PRISM/memory-bank/ (all 16+ files)
- ~/Documents/Claude/PRISM/blitzmetrics-canon/01-nine-triangles.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/02-content-factory-process.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/08-human-requirements.md
- ~/Documents/Claude/PRISM/blitzmetrics-canon/10-anti-vandalism-checklist.md
...
- Section 5: The Team (200 words)
- Section 6: Active Clients and Pipeline (200 words)
- Section 7: Key Relationships (150 words)
- Section 8: Current Strategy & Priorities (300 words)
- Section 9: Available SOPs — full list with one-line descriptions (300 words)
- Section 10: Anti-Vandalism Rules (100 words)
- Section 11: Human-Required Checkpoints (100 words)
- Section 12: Quick Reference — URLs, pricing, KPIs (200 words)

Save to ~/Documents/Claude/PRISM/CONTEXT.md (overwrite existing)
...
- Apprentice program / alternative to college
- Personal branding for service businesses

**WHAT (center):** [Your Agency]'s offers
- $2,500 Certification
- $6,000 Knowledge Panel Sprint
...
6. How We Help Founders Claim Their Google Knowledge Panel
7. The Content Factory: How One Video Becomes 20 Pieces of Content
8. Dollar-a-Day Advertising: Why $1/Day Beats $1,000/Month
9. What Most Founders Get Wrong About Personal Branding
10. How AI Changed Our Entire Marketing Operation in 2026
11. The Influence Report Card: How We Grade Authority
12. Why Your Landing Page Is Not a Website (And Why It Matters)
13. How We Built 50 Articles for a Client Overnight Using AI
14. The Topic Wheel: How to Structure Content That Compounds
15. What I Learned Managing [Your Mentor/Advisor]'s Personal Brand
...
- Book mentions
- Podcast
- Authority signals (university teaching, [Industry Conference], [Your Mentor/Advisor] relationship)
- Professional headshot placement notes
- CTA to [Your Agency] services

---

# PHASE 4: KP BOOK OUTLINE (1 hour)

[Your Mentor/Advisor] keeps pushing for the Knowledge Panel book. The honest assessment flagged this as unfunded opportunity cost.

## Step 4A: Create the Book Outline
...
# PHASE 5: P&L SETUP PREP (30 min)

[Your Mentor/Advisor] has repeatedly asked for P&L tracking. The honest assessment flagged this as a critical gap.
...
- Link to [Your Mentor/Advisor]'s MOF triangle (Marketing, Operations, Finance)
...
# PHASE 6: CLIENT DELIVERABLE PREP (1 hour)

Check the memory bank for active clients and upcoming deliverables:
- Read ~/Documents/Claude/PRISM/memory-bank/04-client-directory.md
- Read ~/Documents/Claude/PRISM/memory-bank/09-project-history.md
- Read ~/Documents/Claude/PRISM/memory-bank/12-strategic-context.md

For each active client or upcoming engagement:
- Create a status summary
- List pending deliverables
- Flag anything overdue
- Prep any content that can be pre-produced (article drafts, audit reports, etc.)

Save to ~/Documents/Claude/PRISM/content-pipeline/client-deliverables-prep.md

---

# PHASE 7: UPDATE EVERYTHING (30 min)
...
```bash
rm -rf ~/Documents/Claude/PRISM/sops/_readable/*
cd ~/Documents/Claude/PRISM/sops && python3 convert_sops_to_docx.py
```

### Regenerate Desktop PRISM Docs
```bash
cd ~/Documents/Claude/PRISM && python3 scripts/convert-all-to-docx.py --include-logs
```

### Write Session Log
Create a comprehensive session log documenting every phase, every file created/modified, every SOP rewritten, every article produced.

---

# PHASE 8: META-ARTICLE ([Your Mentor/Advisor]'s Approach)

Following [Your Mentor/Advisor]'s meta-article concept — document how this entire overnight run was executed.

Create ~/Documents/Claude/PRISM/content-pipeline/meta-article-PRISM-overhaul.md:
- What was the task?
...
- The KP book chapter is real output [Your Mentor/Advisor] has been pushing for — treat it seriously.
- The meta-article proves the system works. Write it as if [Your Mentor/Advisor] will read it.
- Log everything.
- If you finish early, read the SOP audit report for additional issues to fix.
...
- [[claude-code/overnight-blitzmetrics-alignment|[Methodology Partner] Alignment]]
